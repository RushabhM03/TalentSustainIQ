...
class ModelTuner:
    ...
    def best_params_randomforest(self,train_x,train_y):
        # method to get the parameters for Random Forest Algorithm which give the best accuracy. Use Hyper Parameter Tuning.
        try:
    ...
    def best_params_xgboost(self,train_x,train_y):
        # method to get the parameters for XGBoost Algorithm which give the best accuracy.                                    Use Hyper Parameter Tuning.
